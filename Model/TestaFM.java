...
public class TestaFM {
    public static void main(String args[]) {
         ...
         * Equipa e1 = new Equipa("E1"); e1.addJogador(j1); e1.addJogador(j2);
         * e1.addJogador(j3); e1.addJogador(j4); Equipa e2 = new Equipa("E2"); Jogador
         * j5 = new Avancado("Miguel", 1, 10, 10, 10, 10, 10, 10, 10); Jogador j6 = new
         * Defesa("Vasco", 2, 10, 10, 10, 10, 10, 10, 10); Jogador j7 = new
         * Defesa("Diogo", 3, 10, 10, 10, 10, 10, 10, 10); Jogador j8 = new
         * Avancado("Ronaldo", 4, 10, 10, 10, 10, 10, 10, 10); e2.addJogador(j5);
         * e2.addJogador(j6); e2.addJogador(j7); e2.addJogador(j8);
         */
